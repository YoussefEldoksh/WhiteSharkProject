...
import { X, ArrowLeft, CheckCircle2, ChevronLeft, ChevronRight} from "lucide-react"
        ...
        <AnimatePresence mode="sync">
          {isExpanded && (
            <>
              ...
              <motion.div
                layoutId={`card-${uniqueId}`}
                className="fixed inset-x-4 top-[5%] bottom-[5%] md:inset-auto md:top-1/4 md:right-1/3 md:-translate-x-1/2 md:-translate-y-1/2 w-auto md:w-full md:max-w-3xl md:h-49 md:max-h-[80vh] bg-card rounded-3xl overflow-hidden shadow-2xl z-[51] flex flex-col md:flex-row"
                dir="rtl"
                >
