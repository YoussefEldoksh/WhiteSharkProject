        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-4">
              ...
              <a
                href="https://www.instagram.com/white.shark.clean"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-background/10 rounded-lg flex items-center justify-center hover:bg-primary transition-colors"
                aria-label="انستغرام"
              ...
              <a
                href="https://www.facebook.com/whiteshark.clean"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-background/10 rounded-lg flex items-center justify-center hover:bg-primary transition-colors"
                aria-label="فيسبوك"
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <a
                  href="mailto:info@whiteshark.eg"
                  className="text-background/70 hover:text-primary transition-colors text-sm"
                  dir="ltr"
                >
                  info@whiteshark.eg
        ...
        <div className="container-custom py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-background/60 text-sm">
              © {currentYear} White Shark. جميع الحقوق محفوظة.
            </p>
            <p className="text-background/60 text-sm">
              تصنيع منتجات التنظيف بالجملة - مصر
            </p>
          </div>
        </div>
      </div>
