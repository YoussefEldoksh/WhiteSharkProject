  ...
  const features = [
    {
      icon: Factory,
      title: "تصنيع محلي",
      description: "مصنع القرش الابيض مرخص من هيئة التنمية الصناعية وخاضع للرقابة الدورية على التصنيع والمنتجات",
    },
    {
      icon: Award,
      title: "جودة عالية",
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div  className="space-y-6">
            <h3 className="text-2xl md:text-3xl font-bold text-foreground">
              <span className="text-primary"> القرش الابيض - White Shark</span> الرائدون في تصنيع منتجات التنظيف
            </h3>
            <p className="text-muted-foreground text-lg leading-relaxed">
على مدار 10 سنوات خبرة في الصناعة و 7 سنوات خبره فى التصدير للاسواق العربية، تُعد شركة القرش الابيض - White Shark من أبرز الشركات المتخصصة في تصنيع وتوريد ليف المواعين والسلك الاستانلس و ادوات التنظيف عالية الجودة. نفخر بخدمة قاعدة واسعة من تجار الجملة وشركات التوزيع الكبرى.
            </p>
            <p className="text-muted-foreground text-lg leading-relaxed">
              يقع مصنعنا في الإسكندرية - الطريق الدولي، ونمتلك خطوط إنتاج حديثة 
              تمكننا من تلبية الطلبات الكبيرة بجودة ثابتة و أسعار تنافسية للسوق المصري و العربي.
            </p>
            ...
            <div  className="grid grid-cols-3 gap-4 pt-6">
              ...
              <div className="text-center p-4 bg-accent rounded-lg">
                ...
                <div className="text-sm text-muted-foreground">عميل راض</div>
              </div>
              <div className="text-center p-4 bg-accent rounded-lg">
